    ...
    return (
      <div data-tour={dataTour} className="flex-none">
        ...
        <div
          ...
          style={{ height: 40, background: '#242628' }}
          onMouseDown={(e) => {
            if (
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isActive ? '#1d1f21' : 'transparent',
                  }}
        ...
        {/* Row 2: Toolbar (hamburger + nav + breadcrumb) */}
        <div
          className="border-xp-border flex items-center gap-0.5 border-t px-2"
          style={{ height: 42, background: '#1f2123' }}
        >
          <button
